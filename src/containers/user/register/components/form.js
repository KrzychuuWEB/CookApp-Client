...
import registerProcess from "../../../../services/user/registerProcess";
import InformationDialog from "../../../../components/mui/informationDialog";
import { useHistory } from "react-router-dom";
import {createSnackNotification} from "../../../../services/notifications/snackbar/duck/operations";
...
const UserRegisterForm = ({ handleSubmit, submitting, changeAccountPage }) => {
    ...
    const sendDataToApi = async (formData) => {
        await registerProcess(formData)
            .catch(() => {
